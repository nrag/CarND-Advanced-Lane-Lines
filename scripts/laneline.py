...
class LaneLine():
    ...
    def visualize_band(self, undistorted, perspective):
        """
        ...
        out_img = np.zeros_like(undistorted)
        ...
        lane_band = cv2.addWeighted(out_img, 1, window_img, 0.3, 0)
       
        # Warp the blank back to original image space using inverse perspective matrix (Minv)
        newwarp = perspective.unwarp(lane_band)
